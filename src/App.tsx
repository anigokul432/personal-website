          ...
          <div className="mt-4 flex gap-3">
            {project.demoLink && (
              <a
                ...
                className="text-lg px-2 md:px-4 py-2 rounded bg-transparent border border-blue-800 text-blue-800 hover:bg-blue-900 hover:text-white transition-all"
              >
                Demo
              </a>
            )}
            {project.frontendLink && (
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-lg px-2 md:px-4 py-2 rounded bg-blue-800 text-white hover:bg-blue-900 transition-all"
              >
                Frontend
              </a>
            )}
